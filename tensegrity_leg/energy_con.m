function P = energy_con(q,l,k)  
    ...
    P = distance(x,8,1,5,1,1,l,k) + distance(x,8,1,1,1,2,l,k) + distance(x,8,1,2,1,3,l,k) + ...
        ...
        distance(x,9,1,2,2,7,l,k) + distance(x,9,1,5,2,8,l,k) + distance(x,1,2,6,2,9,l,k) + ...
        distance(x,1,1,6,2,10,l,k) + distance(x,2,2,6,1,11,l,k) + distance(x,2,1,6,1,12,l,k) + ...
